...
public class DatabaseDataWorker {
    ...
    private void insertCourse(String courseId, String title) {
        ...
        values.put(NoteKeeperDatabaseContract.CourseInfoEntry.COURSE_ID_COLUMN, courseId);
        values.put(NoteKeeperDatabaseContract.CourseInfoEntry.COURSE_TITLE_COLUMN, title);
     ...
     private void insertNote(String courseId, String title, String text) {
        ContentValues values = new ContentValues();
        values.put(NoteKeeperDatabaseContract.NoteInfoEntry.COURSE_ID_COLUMN, courseId);
        values.put(NoteKeeperDatabaseContract.NoteInfoEntry.NOTE_TITLE_COLUMN, title);
        values.put(NoteKeeperDatabaseContract.NoteInfoEntry.NOTE_TEXT_COLUMN, text);
